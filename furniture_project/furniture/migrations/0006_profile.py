...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('furniture', '0005_city_customer_order_orderproduct_shippingaddress'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='furniture.city', verbose_name='Город')),
